                ...
                <div class="main_hd">
                    ...
                    <div class="title_tab">
                        <ul class="tab_ul dib-wrap">
                            ...
                            <li class="dib selected"><a href="chart_line.php">曲线图</a></li>
                    ...
                    <div class="main_bd_inner clearfix">
                        <div class="ui_col_24">
                            ...
                            <script type="text/javascript">
                                ...
                                Manage.chartLine(chartJson, 'chartLineView1');
                            </script>
                        </div>
                        <div class="ui_col_24">
                            <label class="ui_label">ajax请求获取</label>
                            <a href="javascript:void(0);" class="ui_button r3" target="ajaxTodo" data-opt='{
                                url: "Data/Json/chartLine.php",
                                param: "",
                                callback: "chartLineSuccess"
                            }'>获取曲线图数据</a>
                            <div id="chartLineView2"></div>
                            <script type="text/javascript">
                                function chartLineSuccess(json){
                                    Manage.chartLine(json, 'chartLineView2');
                                }
                            </script>
                        </div>
                    </div>
